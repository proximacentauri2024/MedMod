...
#SBATCH --output /scratch/se1525/mml-ssl/checkpoints/phenotyping/finetune/ft_train_cxr_%j.log
#SBATCH -e /scratch/se1525/mml-ssl/checkpoints/phenotyping/finetune/ft_train_cxr_%j.err
