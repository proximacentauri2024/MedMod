...
#SBATCH --output /scratch/se1525/mml-ssl/checkpoints/mortality/finetune/ft_train_ehr_%j.log
#SBATCH -e /scratch/se1525/mml-ssl/checkpoints/mortality/finetune/ft_train_ehr_%j.err
