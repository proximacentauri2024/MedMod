...
#SBATCH --output /scratch/se1525/mml-ssl/checkpoints/mortality/finetune/ft_train_cxr_vicreg_%j.log
#SBATCH -e /scratch/se1525/mml-ssl/checkpoints/mortality/finetune/ft_train_cxr_vicreg_%j.err
...
--tag finetuning_cxr_mortality_vicreg \
