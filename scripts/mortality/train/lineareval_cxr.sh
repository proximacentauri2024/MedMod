...
#SBATCH --job-name linear_train_cxr_mortality
#SBATCH --output /scratch/se1525/mml-ssl/checkpoints/mortality/lineareval/linear_train_cxr_%j.log
#SBATCH -e /scratch/se1525/mml-ssl/checkpoints/mortality/lineareval/linear_train_cxr_%j.err
...
--tag linear_train_cxr_mortality \
