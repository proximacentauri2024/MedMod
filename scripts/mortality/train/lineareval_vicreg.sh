...
#SBATCH --job-name linear_train_mortality_vicreg
#SBATCH --output /scratch/se1525/mml-ssl/checkpoints/mortality/lineareval/linear_train_vicreg_%j.log
#SBATCH -e /scratch/se1525/mml-ssl/checkpoints/mortality/lineareval/linear_train_vicreg_%j.err
...
--tag linear_train_mortality_vicreg \
