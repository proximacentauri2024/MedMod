...
#SBATCH --output /scratch/se1525/mml-ssl/checkpoints/radiology/finetune/ft_train_cxr_%j.log
#SBATCH -e /scratch/se1525/mml-ssl/checkpoints/radiology/finetune/ft_train_cxr_%j.err
