...
#SBATCH --output /scratch/se1525/mml-ssl/checkpoints/radiology/finetune/ft_train_%j.log
#SBATCH -e /scratch/se1525/mml-ssl/checkpoints/radiology/finetune/ft_train_%j.err
