...
#SBATCH --output /scratch/se1525/mml-ssl/checkpoints/radiology/lineareval/linear_train_cxr_vicreg_%j.log
#SBATCH -e /scratch/se1525/mml-ssl/checkpoints/radiology/lineareval/linear_train_cxr_vicreg_%j.err
...
--tag linear_train_cxr_vicreg_radiology \
